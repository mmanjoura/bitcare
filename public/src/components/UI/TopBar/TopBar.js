    ...
    return(
        ...
        <div className="topbar-column"><a className="hidden-md-down" href="#"><i className="icon-download" />&nbsp; Get mobile app</a>
          <div className="lang-currency-switcher-wrap">
            <div className="lang-currency-switcher dropdown-toggle"><span className="language"><img alt="English" src="img/GB.png" /></span><span className="currency">$ USD</span></div>
            <div className="dropdown-menu">
              ...
              </div><a className="dropdown-item" href="#"><img src="img/FR.png" alt="Français" />Français</a><a className="dropdown-item" href="#"><img src="img/DE.png" alt="Deutsch" />Deutsch</a><a className="dropdown-item" href="#"><img src="img/IT.png" alt="Italiano" />Italiano</a>
            </div>
          </div>
        </div>
