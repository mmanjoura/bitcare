    ...
    return(
        ...
        <div className="site-branding">
          <div className="inner">
            ...
            {/* Site Logo*/}<a className="site-logo" href="index.html"><img src="img/logo.png" alt="Unishop" /></a>
          </div>
        </div>
        {/* Main Navigation*/}
          ...
          <ul>
            <li className="has-megamenu active"><a href="index.html"><span>Home</span></a>
              <ul className="mega-menu">
                <li><a className="d-block img-thumbnail text-center navi-link" href="index.html"><img alt="Featured Products Slider" src="img/01.jpg" />
                    <h6 className="mt-3">Featured Products Slider</h6></a></li>
                <li><a className="d-block img-thumbnail text-center navi-link" href="home-featured-categories.html"><img alt="Featured Categories" src="img/02.jpg" />
                    <h6 className="mt-3">Featured Categories</h6></a></li>
                <li><a className="d-block img-thumbnail text-center navi-link" href="home-collection-showcase.html"><img alt="Products Collection Showcase" src="img/03.jpg" />
                    <h6 className="mt-3">Products Collection Showcase</h6></a></li>
                <li>
                  <div className="img-thumbnail text-center"><img alt="More To Come. Stay Tuned!" src="img/04.jpg" />
            ...
            <li className="has-megamenu"><a href="#"><span>Mega Menu</span></a>
              <ul className="mega-menu">
                ...
                <li>
                  <section className="promo-box" style={{backgroundImage: 'url(img/02.jpg)'}}><span className="overlay-dark" style={{opacity: '.4'}} />
              ...
              <div className="account"><a href="account-orders.html" /><i className="icon-head" />
                <ul className="toolbar-dropdown">
                  <li className="sub-menu-user">
                    <div className="user-ava"><img src="img/user-ava-sm.jpg" alt="Daniel Adams" />
                    </div>
